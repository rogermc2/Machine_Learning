...
package body Encode_Utils is
   ...
   begin
      ...
      Print_Utilities.Print_Value_Data_List
   ...
   begin
      ...
      if Check_Unknown then
         ...
         if not Diff.Is_Empty then
            ...
            Print_Utilities.Print_Value_Data_List ("Unique list", Uniques);
            Print_Utilities.Print_Value_Data_List ("Unseen labels", Diff);
            raise Encode_Error;
         end if;
      end if;
