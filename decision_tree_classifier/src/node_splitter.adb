...
--          ("Node_Splitter.Evaluate_All_Splits before loop Best", Best);
      ...
      while P_Index < Self.End_Row loop
         ...
         Printing.Print_Split_Record
           ("Node_Splitter.Evaluate_All_Splits after 1st loop Best", Best);
   ...
   begin
      ...
      Printing.Print_Split_Record
        ("Node_Splitter.Split_Node Best_Split", Best_Split);
