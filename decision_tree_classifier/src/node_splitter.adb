...
package body Node_Splitter is
    ...
    function Split_Node (Self              : in out Splitter_Class;
        ...
        Num_Known_Constants       : constant Natural
          :=  Constant_Features.Element (1).Integer_Value;
        Samples                   : Classifier_Types.Natural_List :=
                                      Self.Sample_Indices;
        Features                  : Classifier_Types.Natural_List :=
        ...
        Best                      : Split_Record;
        Current                   : Split_Record;
        Total_Constants           : ML_Types.Value_Data_List :=
                                      Constant_Features;
    ...
    begin
        ...
        --  L323
        while F_I > Natural (Total_Constants.Length) and
        ...
        Constant_Features := Total_Constants;
        return Best;
