...
package body Node_Splitter is
    ...
    procedure Find_Best_Split (Self       : in out Splitter_Class;
        ...
        LE                        : Boolean;
    begin
        Assert (Current.Split_Row > Self.Start_Row,
        ...
        Put_Line ("Node_Splitter.Find_Best_Split L379, start, end: " &
                    Integer'Image (Self.Start_Row) &
                    Integer'Image (Self.End_Row));
        Put_Line ("Node_Splitter.Find_Best_Split L379, start, end length: " &
                    Integer'Image (Self.End_Row - Self.Start_Row + 1));
        ...
        while P_Index < Self.End_Row loop
            ...
            while P_Index + 1 <= Self.End_Row and LE loop
                Put_Line ("Node_Splitter.Find_Best_Split Features_X length" &
