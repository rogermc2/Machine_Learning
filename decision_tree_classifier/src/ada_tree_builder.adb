...
package body Ada_Tree_Builder is
    ...
    begin
        ...
        Put_Line (Routine_Name & " L220 Parent is Leaf_Node: " &
                    Boolean'Image (Element (Data.Parent_Cursor).Leaf_Node));
        ...
        Put_Line (Routine_Name & " L238 Child " &
                    Integer'Image (Node_ID) & " is Leaf_Node: " &
                    Boolean'Image (Element (Child_Cursor).Leaf_Node));
