...
package body Ada_Tree_Build is
   ...
   begin
      ...
      Put_Line ("Ada_Tree_Build.Add_Branch L237");
      Node_Value (Splitter, Value);
      --  Update theTree.Values
      for index in 1 .. theTree.Num_Outputs loop
         Outputs := theTree.Values.Element (Positive (index));
      end loop;
      Classes.Clear;
      ...
      for index in 1 .. theTree.Num_Outputs loop
         ...
         theTree.Values.Replace_Element (Positive (index), Outputs);
      end loop;
