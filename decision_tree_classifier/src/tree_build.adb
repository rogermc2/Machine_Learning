...
package body Tree_Build is
   ...
   function Add_Node (theTree               : in out Tree.Tree_Class;
                      ...
                      Weighted_Node_Samples : Float) return Tree.Tree_Node is
      use Tree;
      use Tree_Package;
   ...
   begin
      ...
      Res.Node := Add_Node (theTree, Parent_Cursor, Is_Left, Is_Leaf,
   ...
   begin
      ...
      while Has_Element (Curs) loop
         ...
         if not Node.Is_Leaf then
            ...
            Add_Split_Node
              (Best_Builder, Splitter, theTree, Node.Impurity,
               False, Node.Is_Left, Node, Node.Depth + 1, Split_Node_Left);
            --  tree.nodes may have changed
            Heap_Record := Element (Curs);
            Node := Heap_Record.Node;
            Add_Split_Node
              (Best_Builder, Splitter, theTree,
               Heap_Record.Impurity_Right, False, False, Node, Node.Depth + 1,
               Split_Node_Right);
