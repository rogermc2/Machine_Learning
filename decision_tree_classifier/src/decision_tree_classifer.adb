...
package body Decision_Tree_Classifer is
    ...
    procedure Base_Fit
      (aClassifier   : in out Classifier;
       ...
       Y             : out ML_Types.List_Of_Value_Data_Lists;
       Sample_Weight : out Classifier_Types.Float_List) is
        ...
        Min_Split  : Split_Record (Tree.Integer_Type);
    begin
        --  L207
        ...
        case aClassifier.Parameters.Min_Samples_Split.Split_Type is
            when Tree.Integer_Type =>
                ...
                Min_Split := aClassifier.Parameters.Min_Samples_Split;
            when Tree.Float_Type =>
                --  260
                ...
                Min_Split.Min_Split :=
                  Integer (Float'Ceiling (aClassifier.Parameters.Min_Samples_Split.Min_Fraction_Split));
                if Min_Split.Min_Split < 2 then
                    Min_Split.Min_Split := 2;
                end if;
            when others =>
                raise Value_Error with
