...
package body Classifier_Utilities is
    ...
    begin
        ...
        if Node.Leaf_Node then
            Print_List_Of_Value_Data_Lists (To_String (UB_Offset & "Prediction: "),
                                            Node.Values);
        else
    ...
    begin
        for index in theList.First_Index .. theList.Last_Index loop
            Print_Value_Data_List (Name, theList.Element (index));
        end loop;
    ...
    begin
        for index in theList.First_Index .. theList.Last_Index loop
            Print_Value_Data_List_2D (Name, theList.Element (index));
        end loop;
