...
procedure Test_Make_Classification is

   Routine_Name        : constant String := "Test_Make_Classification ";
   Weights             : constant Real_Float_Vector (1 .. 2) := (0.1, 0.25);
