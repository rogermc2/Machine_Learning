...
package Label is
   ...
   type Label_Binarizer
     (Y_Kind     : Multiclass_Utils.Y_Type := Multiclass_Utils.Y_Unknown) is
      record
         Neg_Label : Float := 0.0;
         Pos_Label : Float := 1.0;
   ...
   type Label_Encoder (Encoder_Kind : Class_Type; Num_Items : Positive) is
      record
         ...
         case Encoder_Kind is
            ...
            when Class_Label_List =>
               Classes_List              : ML_Types.Integer_List;
         end case;
      end record;
   ...
   function Inverse_Transform (Self : UB_Multi_Label_Binarizer;
                               Y    : Binary_Matrix)
                               return Unbounded_String_Array_List;
   function Inverse_Transform (Self : Multi_Label_Binarizer; Y : Binary_Matrix)
                               return Integer_Matrix;
