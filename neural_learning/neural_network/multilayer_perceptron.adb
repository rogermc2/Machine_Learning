...
package body Multilayer_Perceptron is
    ...
    begin
        ...
        for layer in 1 .. Num_Layers loop
            ...
            begin
                Put_Line (Routine_Name & "declare start");
                Activ_Coeff := Activ_Coeff + Params.Intercept_Grads;
                Put_Line (Routine_Name & "Activ_Coeff set");
                ...
                Put_Line (Routine_Name & "Activ_Coeff updated");

                if layer = Num_Layers - 1 then
                    Activ_Out := Activ_Coeff;
                end if;
                Put_Line (Routine_Name & "end declare");
            end;
            Put_Line (Routine_Name & "end loop");
        end loop;
    ...
    begin
        Put_Line ("Multilayer_Perceptron.Predict");
