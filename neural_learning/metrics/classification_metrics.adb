...
package body Classification_Metrics is
   ...
   procedure Check_Targets (Y_True       : Integer_Matrix;
                            Y_Prediction : Binary_Matrix);
   function Weighted_Sum
     (Sample_Score : Real_Float_Matrix; Normalize : Boolean := False)
      return Float;
   function Weighted_Sum
...
--        Printing.Print_Float_Matrix (Routine_Name & "Score", Score, 1, 10);
  ...
  --  L144
   ...
   function Average (Sample_Score : Real_Float_Matrix) return Float is
   begin
      return Neural_Maths.Mean (Sample_Score);
   ...
   procedure Check_Targets (Y_True, Y_Prediction : Integer_Matrix) is
      ...
      Routine_Name : constant String :=
                       "Classification_Metrics.Check_Targets ";
