...
--  This is the version for x86_64-apple-darwin15
...
package AWS.OS_Lib is
   ...
   Target_Name          : constant String  := "x86_64-apple-darwin15";
   ...
   FIONWRITE            : constant := 1074033779;  --  How many bytes in the send queue
