...
package body Stochastic_Optimizers is
    ...
    begin
        ...
        --                    & " x" & Count_Type'Image
        --                      (Self.First_Moments (1).Coeff_Grads'Length (2)));
        --          Put_Line (Routine_Name & "First_Moments Intercept_Grads length" &
        --                      Count_Type'Image (Self.First_Moments (1).
        --                        Intercept_Grads'Length));
        --          Put_Line (Routine_Name & "Grads.First_Index" &
        --                      Integer'Image (Grads.First_Index));
        --  L272
