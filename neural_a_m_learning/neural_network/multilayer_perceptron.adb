   ...
   begin
      ...
      for layer in 1 .. Num_Layers - 1 loop
         ...
         begin
            ...
            begin
               Put_Line (Routine_Name & "Activations length (layer):" &
                           Count_Type'Image (Activ1'Length));
               Put_Line (Routine_Name & "Activations length (layer + 1):" &
                           Count_Type'Image (Activ2'Length));
            end;
