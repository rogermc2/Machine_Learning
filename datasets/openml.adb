...
package body Openml is
    ...
    function Get_Json_Content_From_File (URL : String) return JSON_Array;
    ...
    function Get_Json_Content_From_File (URL : String) return JSON_Array is
    ...
    begin
        ...
        begin
            ...
            JSON_Text := To_Unbounded_String (Get_Line (File));
            Close (File);
        end;

        JSON_Main_Node := Read (JSON_Text, Filename => "");
        Put_Line (Routine_Name & "JSON_Main_Node set");
        JSON_Result_Array := Get (JSON_Main_Node);
        Put_Line (Routine_Name & "JSON_Result_Array set");
