...
--                            return Real_Float_Vector;
   ...
   function Approx_Derivative
     (Fun                : Deriv_Fun_Access; X0 : Real_Float_Vector;
      ...
      Loc_Bounds    : constant Opt_Constraints.Bounds_List :=
...
--        end if;
   ...
   --  -------------------------------------------------------------------------
   --  L547
   function Dense_Difference
     (W_Fun  : Deriv_Fun_Access; X0  : Real_Float_Vector;
      F0     : Real_Float_Vector; H, Use_One_Sided : Real_Float_Vector;
