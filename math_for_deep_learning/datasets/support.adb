...
package body Support is
   ...
   function Get_State
     (Dataset               : Load_Dataset.Digits_Data_Record;
      ...
      Routine_Name : constant String := "Support.Get_State ";
   ...
   function Get_State
     (Dataset_Name : String; Train_Size, Test_Size : Positive;
      ...
      use Stream_IO;
      Routine_Name   : constant String := "Support.Get_State ";
      Dataset_File   : constant String := "../" & Dataset_Name & ".csv";
      ...
      if Has_Data then
         ...
         declare
            Data        : constant Load_Dataset.Digits_Data_Record :=
              Neural_Processes.Load_Data_Set (Data_Directory & "mnist_784.csv",
