...
package Classifier_Utilities is
    ...
    type Feature_Type_Array is array (Positive range <>) of IL_Types.Data_Type;
    type Label_Type_Array is array (Positive range <>) of IL_Types.Data_Type;
    ...
    function Load_Data (File_Name : String; Num_Outputs : Positive := 1)
                       return IL_Types.Multi_Output_Data_Record;
    ...
    function To_Natural_Value_List (A : Natural_Array)
                                   return IL_Types.Value_Data_Lists_2D;
    function To_PL_Array (List_1D  : IL_Types.Value_Data_List;
                          Num_Rows : Positive)
