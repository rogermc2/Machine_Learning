...
package body Classifier_Loader is
   ...
   function Split_Raw_Data
     (Raw_Data : ML_Types.Raw_Data_Vector; Num_Outputs : Natural := 1)
      return Multi_Output_Data_Record;

   --  -------------------------------------------------------------------------

   function Load_Data
     (File_Name : String; Num_Outputs : Natural := 1;
      Max_Lines : Positive := 20_000) return ML_Types.Multi_Output_Data_Record
   is
   ...
   procedure Parse_Header
     (Header      :        ML_Types.Unbounded_List; Num_Features : Positive;
      Data_Record : in out Multi_Output_Data_Record)
   is
   begin
   ...
   is
      ...
      Routine_Name   : constant String := "Classifier_Loader.Split_Raw_Data ";
