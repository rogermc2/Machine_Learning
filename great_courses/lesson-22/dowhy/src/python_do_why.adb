...
package body Python_Do_Why is

   function To_Tuple (Data : Support_Do_Why.Data_List) return PyObject_Ptr;
...
--        Routine_Name    : constant String := "Python_22A.Set_Model ";
   ...
   function To_Tuple (Data : Support_Do_Why.Data_List) return PyObject_Ptr is
      use Support_Do_Why.Data_Package;
