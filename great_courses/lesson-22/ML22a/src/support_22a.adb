...
package body Support_22A is
   ...
   procedure Plot_Sentence (Classifier : Python.Module;
      ...
      use Python_CLF;
      Routine_Name     : constant String := "Support_22A.Plot_Sentence ";
      Class_Log_Prior  : constant Python_API.PyObject_Ptr :=
                           Get_Attribute (CLF, "class_log_prior_");
      Feature_Log_Prob : constant Python_API.PyObject_Ptr :=
