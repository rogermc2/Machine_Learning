...
procedure Lesson_4A_Neuron is
   ...
   Train_Y       : constant Integer_Matrix := To_Integer_Matrix (Data.Train_Y);
...
begin
   ...
   for row in Test_Y'Range loop
      Test_Y (row, 1) := Integer (Data.Test_Y (row));
   end loop;
