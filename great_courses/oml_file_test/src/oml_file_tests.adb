...
--        Save_File     : constant String := "diabetes.oml";
      ...
      X             : AR_Types.AR_Data_List_2D;
      Y             : AR_Types.AR_Data_List_2D;
      Bunch         : Bunch_Data;
   begin
      ...
      Printing.Print_AR_Data_Lists_2D (Routine_Name & "X", X, 2);
      Printing.Print_AR_Data_Lists_2D (Routine_Name & "Y", Y, 2);
