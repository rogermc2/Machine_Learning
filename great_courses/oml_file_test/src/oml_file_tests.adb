    ...
    begin
        ...
        if Is_Empty (Quality_Array) then
            ...
            while Array_Has_Element (Quality_Array, Index) loop
                ...
                Put_Line ("aFeature JSON type: " &
                           JSON_Value_Type'Image (Kind (Quality)));
                case Kind (Quality) is
                when JSON_Array_Type =>
                     Put_Line ("JSON_Array");
--                      Array_Quality := Get (Quality);
--                      Put_Line ("Quality index: " & Integer'Image (Get (Quality)));
                when JSON_Boolean_Type =>
--                      Bool_Quality := Get (Value);
                    Put_Line ("Quality index: " & Boolean'Image (Get (Quality)));
                when JSON_Float_Type =>
--                      Float_Quality := Get (Value);
                    Put_Line ("Quality index: " & Float'Image (Get (Quality)));
                when JSON_Int_Type =>
--                      Int_Quality := Get (Value);
                ...
                when JSON_String_Type =>
                    Put_Line ("Quality index: " & Get (Quality));
--                      declare
